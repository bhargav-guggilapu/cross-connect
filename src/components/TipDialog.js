...
import { convertCurrency } from "./Helpers/staticFunctions";
    ...
    <>
          ...
          <div className="mt-6 mb-6 mr-3 ml-3 flex justify-between">
            <div className="flex flex-col items-center justify-between basis-1/4">
              <Avatar
                ...
                src={selectedOrder?.agent?.photo || "NO IMAGE"}
                alt={selectedOrder?.agent?.firstName}
      ...
      {isPayOpen && (
        <PaymentModel
          ...
          onSuccessPayment={() => onTipConfirm(selectedOrder._id, tipAmount)}
          orderId={selectedOrder._id}
          tipAmount={tipAmount}
          paymentItemsList={[
            {
              label: "Tip Amount",
              amount: convertCurrency("USD", tipAmount),
            },
          ]}
        />
      )}
